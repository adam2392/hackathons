...
@brief remote control driver definition for the Leebot robot.
@author Adam Li
*/
...
namespace Leebot
{
	...
	public:
		...
		*/
		...
		@param cmd: a reference to the command_t struct where the command 
			information will be stored.
		@return true: if remote command is available, false if not
		*/
